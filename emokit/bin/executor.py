...
class Executor:
    ...
    def train(self, model, optimizer, scheduler, data_loader, device, writer,
        ...
        for batch_idx, (feats,text_tokens, target) in enumerate(data_loader):
    ...
    def cv(self, model, data_loader, device, args):
        ...
        return total_loss, num_seen_utts,test_acc
    ...
    def evaluation(self, model, data_loader, device):
        ...
        gt_labels , pred_labels = list(), list()
        with torch.no_grad():
            for batch_idx, (feats,text_tokens,target) in enumerate(tqdm.tqdm(data_loader)):
